"""
Django settings for funny_stories_project project.
...
ROOT_URLCONF = 'funny_stories_project.urls'
...
WSGI_APPLICATION = 'funny_stories_project.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'FunnyStory$default',
        'USER': 'FunnyStory',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'FunnyStory.mysql.pythonanywhere-services.com',
        'OPTIONS': {
